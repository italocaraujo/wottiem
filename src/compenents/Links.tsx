...
const Links = () => (
    <div className={styles.linksStreamingsWtt}>
        <ul>
            <li>
                <a href="#" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className={styles.biSpotify} viewBox="0 0 20 20">
            ...
            <li>
                <a href="#" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg"  className={styles.biAppleMusic} version="1.1" id="Artwork" x="0px" y="0px" width="27px" height="27px" viewBox="0 0 361 361">
            ...
            <li>
                <a href="https://www.youtube.com/@kyoto.records" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className={styles.biYoutube} viewBox="0 0 20 20">
            ...
            <li>
                <a href="https://www.instagram.com/wottiem/" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className={styles.biInstagram} viewBox="0 0 20 20">
